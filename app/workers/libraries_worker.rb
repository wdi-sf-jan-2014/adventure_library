...
# >>My attempt would have failed because I did not have a method I could call upon in a recursive way.  Kai uses the perform method after new_lib is 
# >>defined and that allows her methods to work versus run once.
